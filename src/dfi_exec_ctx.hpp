...
namespace dfi {
    ...
    class dfi_function_not_found: public runtime_error {
    public:
        dfi_function_not_found(std::int64_t l, std::int64_t c, const std::string &msg):
            runtime_error{l, c, msg}
        {
        }
    };
    class dfi_identifier_not_found: public runtime_error {
    public:
        dfi_identifier_not_found(std::int64_t l, std::int64_t c, const std::string &msg):
            runtime_error{l, c, msg}
        {
        }
    };
    class dfi_global_identifier_exists: public runtime_error {
    public:
        dfi_global_identifier_exists(std::int64_t l, std::int64_t c, const std::string &msg):
            runtime_error{l, c, msg}
        {
        }
    };
    ...
    public:
        ...
        valbox find_val_by_sym_name(std::string const &name, int64_t l, int64_t c) {
            ...
            throw dfi_identifier_not_found{l, c, std::string{"identifier \""} + name + "\" not found"};
        }
