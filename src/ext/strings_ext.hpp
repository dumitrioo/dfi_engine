...
namespace dfi {
    ...
    public:
        ...
        void register_runtime(runtime_interface *rt) override {
            ...
            rt_->add_function("atoi", DFIFUN(args) {
            ...
            rt_->add_function("atoui", DFIFUN(args) {
            ...
            rt_->add_function("utoa", DFIFUN(args) {
                if(args.size() > 0) {
                    if(args.size() > 1) {
                        if(args.size() > 2) {
                            if(args.size() > 3) {
            ...
            rt_->add_function("ftoa", DFIFUN(args) {
                if(args.size() > 0) {
                    if(args.size() > 1) {
            ...
            rt_->add_function("toupper", DFIFUN(args) {
                DFI_CHCK_FUN_PARMS_NUM_EQ(args, 1)
                if(args[0].is_char()) {
            ...
            rt_->add_function("tolower", DFIFUN(args) {
                DFI_CHCK_FUN_PARMS_NUM_EQ(args, 1)
                if(args[0].is_char()) {
            ...
            rt_->add_function("strtoupper", DFIFUN(args) {
                DFI_CHCK_FUN_PARMS_NUM_EQ(args, 1)
                if(args[0].is_string()) {
            ...
            rt_->add_function("strtolower", DFIFUN(args) {
                DFI_CHCK_FUN_PARMS_NUM_EQ(args, 1)
                if(args[0].is_string()) {
            ...
            rt_->add_function("replace_substr", DFIFUN(args) {
            ...
            rt_->add_function("substr", DFIFUN(args) {
                DFI_CHCK_FUN_PARMS_NUM_IN_RANGE(args, 1, 3)
                if(args.size() == 1) {
            ...
            rt_->add_function("split", DFIFUN(args) {
            ...
            rt_->add_function("ltrim", DFIFUN(args) {
                DFI_CHCK_FUN_PARMS_NUM_EQ(args, 1)
                if(args[0].is_string()) {
            ...
            rt_->add_function("rtrim", DFIFUN(args) {
                DFI_CHCK_FUN_PARMS_NUM_EQ(args, 1)
                if(args[0].is_string()) {
            ...
            rt_->add_function("trim", DFIFUN(args) {
                DFI_CHCK_FUN_PARMS_NUM_EQ(args, 1)
                if(args[0].is_string()) {
            ...
            rt_->add_function("isspace", DFIFUN(args) { DFI_CHCK_FUN_PARMS_NUM_EQ(args, 1) return str_util::fltr<std::wstring>::isspace(args[0].cast_to_int()); });
            rt_->add_function("isalpha", DFIFUN(args) { DFI_CHCK_FUN_PARMS_NUM_EQ(args, 1) return str_util::fltr<std::wstring>::isalpha(args[0].cast_to_int()); });
            rt_->add_function("isdigit", DFIFUN(args) { DFI_CHCK_FUN_PARMS_NUM_EQ(args, 1) return str_util::fltr<std::wstring>::isdigit(args[0].cast_to_int()); });
            rt_->add_function("isalnum", DFIFUN(args) { DFI_CHCK_FUN_PARMS_NUM_EQ(args, 1) return str_util::fltr<std::wstring>::isalnum(args[0].cast_to_int()); });
            rt_->add_function("ispunct", DFIFUN(args) { DFI_CHCK_FUN_PARMS_NUM_EQ(args, 1) return str_util::fltr<std::wstring>::ispunct(args[0].cast_to_int()); });
            rt_->add_function("iscntrl", DFIFUN(args) { DFI_CHCK_FUN_PARMS_NUM_EQ(args, 1) return str_util::fltr<std::wstring>::iscntrl(args[0].cast_to_int()); });
            rt_->add_function("ishexdigit", DFIFUN(args) { DFI_CHCK_FUN_PARMS_NUM_EQ(args, 1) return str_util::fltr<std::wstring>::ishexdigit(args[0].cast_to_int()); });
            rt_->add_function("isoctdigit", DFIFUN(args) { DFI_CHCK_FUN_PARMS_NUM_EQ(args, 1) return str_util::fltr<std::wstring>::isoctdigit(args[0].cast_to_int()); });
            rt_->add_function("isbindigit", DFIFUN(args) { DFI_CHCK_FUN_PARMS_NUM_EQ(args, 1) return str_util::fltr<std::wstring>::isbindigit(args[0].cast_to_int()); });

            rt_->add_function("hexdump", DFIFUN(args) {
            ...
            rt_->add_function("data_to_base64_str", DFIFUN(args) {
                DFI_CHCK_FUN_PARMS_NUM_IN_RANGE(args, 1, 1)
                auto src{args[0].cast_to_byte_array()};
                return data_to_base64_str(src);
            });

            rt_->add_function("base64_str_to_data", DFIFUN(args) {
                DFI_CHCK_FUN_PARMS_NUM_IN_RANGE(args, 1, 1)
                auto src{args[0].cast_to_string()};
            ...
            rt_->add_function("data_to_hex_str", DFIFUN(args) {
                DFI_CHCK_FUN_PARMS_NUM_IN_RANGE(args, 1, 1)
                auto src{args[0].cast_to_byte_array()};
                return data_to_hex_str(src);
            });

            rt_->add_function("hex_str_to_data", DFIFUN(args) {
                DFI_CHCK_FUN_PARMS_NUM_IN_RANGE(args, 1, 1)
                auto src{args[0].cast_to_string()};
            ...
            rt_->add_function("find_substr", DFIFUN(args) {
                DFI_CHCK_FUN_PARMS_NUM_IN_RANGE(args, 2, 3)
                if(args[0].is_string()) {
                    if(args[1].is_string()) {
                        if(args.size() == 3) {
                            return str_util::substr_finder_rk{}.find(args[0].as_string(), args[1].as_string(), args[2].cast_to_u64());
                        } else {
                            return str_util::substr_finder_rk{}.find(args[0].as_string(), args[1].as_string());
                        }
                    } else {
                        if(args.size() == 3) {
                            return str_util::substr_finder_rk{}.find(args[0].as_string(), args[1].cast_to_string(), args[2].cast_to_u64());
                        } else {
                            return str_util::substr_finder_rk{}.find(args[0].as_string(), args[1].cast_to_string());
                        }
                    }
                } else if(args[0].is_wstring()) {
                    if(args[1].is_wstring()) {
                        if(args.size() == 3) {
                            return str_util::substr_finder_rk{}.find(args[0].as_wstring(), args[1].as_wstring(), args[2].cast_to_u64());
                        } else {
                            return str_util::substr_finder_rk{}.find(args[0].as_wstring(), args[1].as_wstring());
                        }
                    } else {
                        if(args.size() == 3) {
                            return str_util::substr_finder_rk{}.find(args[0].as_wstring(), args[1].cast_to_wstring(), args[2].cast_to_u64());
                        } else {
                            return str_util::substr_finder_rk{}.find(args[0].as_wstring(), args[1].cast_to_wstring());
                        }
                    }
                } else {
