...
namespace dfi {
    ...
    public:
        ...
        void register_runtime(runtime_interface *rt) override {
            ...
            rt->add_function("pid_regulator", DFIFUN(args) {
                DFI_CHCK_FUN_PARMS_NUM_IN_RANGE(args, 4, 5)
                if(args.size() == 4) {
                    return dfi::valbox{std::make_shared<pid>(args[1].cast_to_double(), args[2].cast_to_double(), args[3].cast_to_double()), "pid_regulator"};
                } else {
                    return dfi::valbox{std::make_shared<pid>(args[1].cast_to_double(), args[2].cast_to_double(), args[3].cast_to_double(), args[4].cast_to_double()), "pid_regulator"};
                }
            });
            rt->add_method("pid_regulator", "set_p", DFIFUN(args) {
                DFI_CHCK_FUN_PARMS_NUM_EQ(args, 2)
                DFITHIS(args, std::shared_ptr<pid>)->set_p(args[1].cast_to_double());
                return true;
            });
            rt->add_method("pid_regulator", "set_i", DFIFUN(args) {
                DFI_CHCK_FUN_PARMS_NUM_EQ(args, 2)
                DFITHIS(args, std::shared_ptr<pid>)->set_i(args[1].cast_to_double());
                return true;
            });
            rt->add_method("pid_regulator", "set_d", DFIFUN(args) {
                DFI_CHCK_FUN_PARMS_NUM_EQ(args, 2)
                DFITHIS(args, std::shared_ptr<pid>)->set_d(args[1].cast_to_double());
                return true;
            });
            rt->add_method("pid_regulator", "set_f", DFIFUN(args) {
                DFI_CHCK_FUN_PARMS_NUM_EQ(args, 2)
                DFITHIS(args, std::shared_ptr<pid>)->set_f(args[1].cast_to_double());
                return true;
            });
            rt->add_method("pid_regulator", "set_pid", DFIFUN(args) {
                DFI_CHCK_FUN_PARMS_NUM_IN_RANGE(args, 4, 5)
                if(args.size() == 4) {
                    DFITHIS(args, std::shared_ptr<pid>)->set_pid(args[1].cast_to_double(), args[2].cast_to_double(), args[3].cast_to_double());
                } else {
                    DFITHIS(args, std::shared_ptr<pid>)->set_pid(args[1].cast_to_double(), args[2].cast_to_double(), args[3].cast_to_double(), args[4].cast_to_double());
                }
                return true;
            });
            rt->add_method("pid_regulator", "set_max_ioutput", DFIFUN(args) {
                DFI_CHCK_FUN_PARMS_NUM_EQ(args, 2)
                DFITHIS(args, std::shared_ptr<pid>)->set_max_ioutput(args[1].cast_to_double());
                return true;
            });
            rt->add_method("pid_regulator", "set_output_limits", DFIFUN(args) {
                DFI_CHCK_FUN_PARMS_NUM_IN_RANGE(args, 2, 3)
                if(args.size() == 2) {
                    DFITHIS(args, std::shared_ptr<pid>)->set_output_limits(args[1].cast_to_double());
                } else {
                    DFITHIS(args, std::shared_ptr<pid>)->set_output_limits(args[1].cast_to_double(), args[2].cast_to_double());
                }
                return true;
            });
            rt->add_method("pid_regulator", "set_direction", DFIFUN(args) {
                DFI_CHCK_FUN_PARMS_NUM_EQ(args, 2)
                DFITHIS(args, std::shared_ptr<pid>)->set_direction(args[1].cast_to_bool());
                return true;
            });
            rt->add_method("pid_regulator", "set_setpoint", DFIFUN(args) {
                DFI_CHCK_FUN_PARMS_NUM_EQ(args, 2)
                DFITHIS(args, std::shared_ptr<pid>)->set_setpoint(args[1].cast_to_double());
                return true;
            });
            rt->add_method("pid_regulator", "set_setpoint_range", DFIFUN(args) {
                DFI_CHCK_FUN_PARMS_NUM_EQ(args, 2)
                DFITHIS(args, std::shared_ptr<pid>)->set_setpoint_range(args[1].cast_to_double());
                return true;
            });
            rt->add_method("pid_regulator", "reset", DFIFUN(args) {
                DFI_CHCK_FUN_PARMS_NUM_EQ(args, 1)
                DFITHIS(args, std::shared_ptr<pid>)->reset();
                return true;
            });
            rt->add_method("pid_regulator", "set_output_ramp_rate", DFIFUN(args) {
                DFI_CHCK_FUN_PARMS_NUM_EQ(args, 2)
                DFITHIS(args, std::shared_ptr<pid>)->set_output_ramp_rate(args[1].cast_to_double());
                return true;
            });
            rt->add_method("pid_regulator", "set_output_filter", DFIFUN(args) {
                DFI_CHCK_FUN_PARMS_NUM_EQ(args, 2)
                DFITHIS(args, std::shared_ptr<pid>)->set_output_filter(args[1].cast_to_double());
                return true;
            });
            rt->add_method("pid_regulator", "get_output", DFIFUN(args) {
                DFI_CHCK_FUN_PARMS_NUM_IN_RANGE(args, 1, 3)
                if(args.size() == 1) {
                    return DFITHIS(args, std::shared_ptr<pid>)->get_output();
                } else if(args.size() == 2) {
                    return DFITHIS(args, std::shared_ptr<pid>)->get_output(args[1].cast_to_double());
                } else {
                    return DFITHIS(args, std::shared_ptr<pid>)->get_output(args[1].cast_to_double(), args[2].cast_to_double());
                }
            });
        }
