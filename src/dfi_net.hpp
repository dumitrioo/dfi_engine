...
namespace dfi {
    ...
    static dfi::net::address_family addr_family_convert(network_address_family nadf) {
        switch(nadf) {
            case network_address_family::unspecified: return dfi::net::address_family::unspecified;
#if defined(PLATFORM_LINUX) || defined(PLATFORM_ANDROID)
            case network_address_family::unix_socket: return dfi::net::address_family::unix_socket;
#endif
            case network_address_family::inet4: return dfi::net::address_family::inet4;
            case network_address_family::inet6: return dfi::net::address_family::inet6;
    ...
    private:
        command_queue *cq_{nullptr};
        std::unique_ptr<dfi::net::udp_server_muxed<1400>> usm_{};
        mutable std::shared_mutex on_data_arrived_mtp_{};
        std::function<void(net::conn_id_t, bytevec const &)> on_data_arrived_{nullptr};
    };
    ...
    public:
        ...
        void start(std::string host, std::uint16_t port) {
            ...
            ucm_ = std::make_unique<dfi::net::udp_client_muxed<1400>>(cq_);
    ...
    private:
        ...
        std::unique_ptr<dfi::net::udp_client_muxed<1400>> ucm_{};
