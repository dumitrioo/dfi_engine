    ...
    namespace crypt {
        ...
        struct gcm {
            ...
            bool init(CIPHER *cipher_context_ptr) {
                ...
                m[j][0] = dfi::bit_util::hnswap<std::uint32_t>{h[3]}.val;
                m[j][1] = dfi::bit_util::hnswap<std::uint32_t>{h[2]}.val;
                m[j][2] = dfi::bit_util::hnswap<std::uint32_t>{h[1]}.val;
                m[j][3] = dfi::bit_util::hnswap<std::uint32_t>{h[0]}.val;
