...
namespace dfi {
    ...
    namespace ssl {
        ...
        namespace rand {
            ...
            static dfi::ssl::bytevec gen_rand_bytes(std::size_t num_bytes) {
                dfi::ssl::bytevec res(num_bytes);
                if(num_bytes > 0) {
            ...
            static dfi::ssl::bytevec gen_rand_priv_bytes(std::size_t num_bytes) {
                dfi::ssl::bytevec res(num_bytes);
                if(num_bytes > 0) {
                    std::lock_guard lck{rng_mtp};
                    /*
            ...
            public:
                ...
                result_type operator()() {
                    ...
                    return dfi::bit_util::swap_on_be{res}.val;
                }
