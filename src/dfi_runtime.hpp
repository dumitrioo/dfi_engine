...
namespace dfi {
    ...
    public:
        runtime() {
            add_function("version_major", DFIFUN(/*args*/) { return version_major_; });
            add_function("version_minor", DFIFUN(/*args*/) { return version_minor_; });
            add_function("version_patch", DFIFUN(/*args*/) { return version_patch_; });
            add_function("version_string", DFIFUN(/*args*/) {
            ...
            add_method("console", "info", DFIFUN(args) {
                DFI_CHCK_FUN_PARMS_NUM_GE(args, 1)
                std::vector<valbox> args1{args.begin() + 1, args.end()};
                DFITHIS(args, console *)->info(args1);
                return {};
            });
            add_method("console", "log", DFIFUN(args) { DFI_CHCK_FUN_PARMS_NUM_GE(args, 1) std::vector<valbox> args1{args.begin() + 1, args.end()}; DFITHIS(args, console *)->log(args1); return {}; });
            add_method("console", "warn", DFIFUN(args) { DFI_CHCK_FUN_PARMS_NUM_GE(args, 1) std::vector<valbox> args1{args.begin() + 1, args.end()}; DFITHIS(args, console *)->warn(args1); return {}; });
            add_method("console", "debug", DFIFUN(args) { DFI_CHCK_FUN_PARMS_NUM_GE(args, 1) std::vector<valbox> args1{args.begin() + 1, args.end()}; DFITHIS(args, console *)->debug(args1); return {}; });
            add_method("console", "error", DFIFUN(args) { DFI_CHCK_FUN_PARMS_NUM_GE(args, 1) std::vector<valbox> args1{args.begin() + 1, args.end()}; DFITHIS(args, console *)->error(args1); return {}; });
            add_method("console", "print", DFIFUN(args) { DFI_CHCK_FUN_PARMS_NUM_GE(args, 1) std::vector<valbox> args1{args.begin() + 1, args.end()}; DFITHIS(args, console *)->print(args1); return {}; });
            add_method("console", "println", DFIFUN(args) { DFI_CHCK_FUN_PARMS_NUM_GE(args, 1) std::vector<valbox> args1{args.begin() + 1, args.end()}; DFITHIS(args, console *)->println(args1); return {}; });
            add_method("console", "flush", DFIFUN(args) { DFI_CHCK_FUN_PARMS_NUM_EQ(args, 1) DFITHIS(args, console *)->flush(); return valbox{}; });
            add_method("console", "fixed", DFIFUN(args) { DFI_CHCK_FUN_PARMS_NUM_EQ(args, 1) DFITHIS(args, console *)->fixed(); return valbox{}; });
            ...
            add_method("console", "fill", DFIFUN(args) { DFI_CHCK_FUN_PARMS_NUM_EQ(args, 1) return DFITHIS(args, console *)->fill(); });
            ...
            add_function("typeof", DFIFUN(args) {
                DFI_CHCK_FUN_PARMS_NUM_EQ(args, 1)
            ...
            add_function("is_i64", DFIFUN(args) { DFI_CHCK_FUN_PARMS_NUM_EQ(args, 1) return args[0].is_s64(); });
            add_function("is_u64", DFIFUN(args) { DFI_CHCK_FUN_PARMS_NUM_EQ(args, 1) return args[0].is_u64(); });
            add_function("is_i32", DFIFUN(args) { DFI_CHCK_FUN_PARMS_NUM_EQ(args, 1) return args[0].is_s32(); });
            add_function("is_u32", DFIFUN(args) { DFI_CHCK_FUN_PARMS_NUM_EQ(args, 1) return args[0].is_u32(); });
            add_function("is_i16", DFIFUN(args) { DFI_CHCK_FUN_PARMS_NUM_EQ(args, 1) return args[0].is_s16(); });
            add_function("is_u16", DFIFUN(args) { DFI_CHCK_FUN_PARMS_NUM_EQ(args, 1) return args[0].is_u16(); });
            add_function("is_i8", DFIFUN(args) { DFI_CHCK_FUN_PARMS_NUM_EQ(args, 1) return args[0].is_s8(); });
            add_function("is_u8", DFIFUN(args) { DFI_CHCK_FUN_PARMS_NUM_EQ(args, 1) return args[0].is_u8(); });
            add_function("is_f32", DFIFUN(args) { DFI_CHCK_FUN_PARMS_NUM_EQ(args, 1) return args[0].is_float(); });
            add_function("is_f64", DFIFUN(args) { DFI_CHCK_FUN_PARMS_NUM_EQ(args, 1) return args[0].is_double(); });
            add_function("is_float", DFIFUN(args) { DFI_CHCK_FUN_PARMS_NUM_EQ(args, 1) return args[0].is_long_double(); });
            add_function("is_char", DFIFUN(args) { DFI_CHCK_FUN_PARMS_NUM_EQ(args, 1) return args[0].is_char(); });
            add_function("is_wchar", DFIFUN(args) { DFI_CHCK_FUN_PARMS_NUM_EQ(args, 1) return args[0].is_wchar(); });
            add_function("is_bool", DFIFUN(args) { DFI_CHCK_FUN_PARMS_NUM_EQ(args, 1) return args[0].is_bool(); });
            add_function("is_string", DFIFUN(args) { DFI_CHCK_FUN_PARMS_NUM_EQ(args, 1) return args[0].is_string(); });
            add_function("is_wstring", DFIFUN(args) { DFI_CHCK_FUN_PARMS_NUM_EQ(args, 1) return args[0].is_wstring(); });
            add_function("is_mat4", DFIFUN(args) { DFI_CHCK_FUN_PARMS_NUM_EQ(args, 1) return args[0].is_mat4(); });
            add_function("is_vec4", DFIFUN(args) { DFI_CHCK_FUN_PARMS_NUM_EQ(args, 1) return args[0].is_vec4(); });
            add_function("is_array", DFIFUN(args) { DFI_CHCK_FUN_PARMS_NUM_EQ(args, 1) return args[0].is_array(); });
            add_function("is_object", DFIFUN(args) { DFI_CHCK_FUN_PARMS_NUM_EQ(args, 1) return args[0].is_object(); });

            add_function("hton", DFIFUN(args) {
                DFI_CHCK_FUN_PARMS_NUM_EQ(args, 1)
            ...
            add_function("i64", DFIFUN(args) { DFI_CHCK_FUN_PARMS_NUM_LE(args, 1) if(args.empty()) { return (std::int64_t)0; } return args[0].cast_to_s64(); });
            add_function("u64", DFIFUN(args) { DFI_CHCK_FUN_PARMS_NUM_LE(args, 1) if(args.empty()) { return (std::uint64_t)0; } return args[0].cast_to_u64(); });
            add_function("i32", DFIFUN(args) { DFI_CHCK_FUN_PARMS_NUM_LE(args, 1) if(args.empty()) { return (std::int32_t)0; } return args[0].cast_to_s32(); });
            add_function("u32", DFIFUN(args) { DFI_CHCK_FUN_PARMS_NUM_LE(args, 1) if(args.empty()) { return (std::uint32_t)0; } return args[0].cast_to_u32(); });
            add_function("i16", DFIFUN(args) { DFI_CHCK_FUN_PARMS_NUM_LE(args, 1) if(args.empty()) { return (std::int16_t)0; } return args[0].cast_to_s16(); });
            add_function("u16", DFIFUN(args) { DFI_CHCK_FUN_PARMS_NUM_LE(args, 1) if(args.empty()) { return (std::uint16_t)0; } return args[0].cast_to_u16(); });
            add_function("i8", DFIFUN(args) { DFI_CHCK_FUN_PARMS_NUM_LE(args, 1) if(args.empty()) { return (std::int8_t)0; } return args[0].cast_to_s8(); });
            add_function("u8", DFIFUN(args) { DFI_CHCK_FUN_PARMS_NUM_LE(args, 1) if(args.empty()) { return (std::uint8_t)0; } return args[0].cast_to_u8(); });
            add_function("f32", DFIFUN(args) { DFI_CHCK_FUN_PARMS_NUM_LE(args, 1) if(args.empty()) { return (float)0; } return args[0].cast_to_float(); });
            add_function("f64", DFIFUN(args) { DFI_CHCK_FUN_PARMS_NUM_LE(args, 1) if(args.empty()) { return (double)0; } return args[0].cast_to_double(); });
            add_function("f128", DFIFUN(args) { DFI_CHCK_FUN_PARMS_NUM_LE(args, 1) if(args.empty()) { return (long double)0; } return args[0].cast_num_to_num<long double>(); });
            add_function("char", DFIFUN(args) { DFI_CHCK_FUN_PARMS_NUM_LE(args, 1) if(args.empty()) { return char{}; } return args[0].cast_to_char(); });
            add_function("wchar", DFIFUN(args) { DFI_CHCK_FUN_PARMS_NUM_LE(args, 1) if(args.empty()) { return wchar_t{}; } return args[0].cast_to_wchar(); });
            add_function("bool", DFIFUN(args) { DFI_CHCK_FUN_PARMS_NUM_LE(args, 1) if(args.empty()) { return false; } return args[0].cast_to_bool(); });
            add_function("string", DFIFUN(args) { DFI_CHCK_FUN_PARMS_NUM_LE(args, 1) if(args.empty()) { return std::string{}; } return args[0].cast_to_string(); });
            add_function("wstring", DFIFUN(args) { DFI_CHCK_FUN_PARMS_NUM_LE(args, 1) if(args.empty()) { return std::wstring{}; } return args[0].cast_to_wstring(); });
            add_function("vec4", DFIFUN(args) {
                ...
                if(args.size() == 1) {
                    if(args[0].is_array() || args[0].is_object()) {
                        ...
                        res.as_vec4()[0] = args[0].cast_to_double();
                    }
                } else {
                    for(std::size_t i = 0; i < 4 && i < args.size(); ++i) {
                        res.as_vec4()[i] = args[i].cast_to_double();
                    }
                }
                return res;
            });
            add_function("mat4", DFIFUN(args) {
                valbox res{valbox::mat4_t::identity()};
                if(args.size() == 16) {
                    for(std::size_t i{0}; i < 16 && i < args.size(); ++i) {
                        res.as_mat4().at_flat_index(i) = args[i].cast_to_double();
                    }
                    ...
                    for(std::size_t i{0}; row_no < 4 && i < args.size(); ++i) {
                        if(args[i].is_array()) {
                            for(std::size_t j{0}; j < 4 && j < args[i].as_array().size(); ++j) {
                                res.as_mat4()[row_no][j] = args[i].as_array()[j].cast_to_double();
                            }
                            ...
                            for(std::size_t j{0}; j < 4 && i < args.size(); ++j) {
                                if(args[i].is_any_fp_number() || args[i].is_any_int_number()) {
                                    res.as_mat4()[row_no][j] = args[i].cast_to_double();
                                    ++i;
                                } else {
                                    break;
                                }
            ...
            add_function("array", DFIFUN(args) {
                valbox res{};
                res.become_array();
            ...
            add_function("object", DFIFUN(args) {
                valbox res{};
                if(args.empty()) {
                    res.become_object();
                    return res;
            ...
            add_function("deserialize", DFIFUN(args) {
                DFI_CHCK_FUN_PARMS_NUM_EQ(args, 1)
                valbox res{};
                if(args[0].is_string()) {
            ...
            add_function("serialize", DFIFUN(args) {
                valbox res{};
                if(args.size() == 1) {
            ...
            add_function("serialize5", DFIFUN(args) {
                valbox res{};
                if(args.size() == 1) {
            ...
            add_function("contains", DFIFUN(args) {
            ...
            add_function("key_exists", DFIFUN(args) {
                DFI_CHCK_FUN_PARMS_NUM_EQ(args, 2)
                auto a1r{args[0].deref()};
                if(a1r.is_object()) {
                    return a1r.as_object().find(args[1].cast_to_string()) != a1r.as_object().end();
            ...
            add_function("string_field_exists", DFIFUN(args) {
                DFI_CHCK_FUN_PARMS_NUM_EQ(args, 2)
                auto a1r{args[0].deref()};
                if(a1r.is_object()) {
                    return a1r.as_object().find(args[1].cast_to_string()) != a1r.as_object().end() &&
            ...
            add_function("key_at", DFIFUN(args) {
                DFI_CHCK_FUN_PARMS_NUM_EQ(args, 2)
                auto a1r{args[0].deref()};
                if(a1r.is_object()) {
            ...
            add_function("value_at", DFIFUN(args) {
                DFI_CHCK_FUN_PARMS_NUM_EQ(args, 2)
                auto a1r{args[0].deref()};
                if(a1r.is_object()) {
            ...
            add_function("resize", DFIFUN(args) {
                DFI_CHCK_FUN_PARMS_NUM_EQ(args, 2)
            ...
            add_function("pop_front", DFIFUN(args) {
                DFI_CHCK_FUN_PARMS_NUM_EQ(args, 1)
                valbox &a1r{args[0].deref()};
                if(a1r.is_array()) {
                    if(a1r.as_array().empty()) {
            ...
            add_function("placement", DFIFUN(args) {
                DFI_CHCK_FUN_PARMS_NUM_EQ(args, 1)
            ...
            add_function("undefine", DFIFUN(args) {
                DFI_CHCK_FUN_PARMS_NUM_EQ(args, 1)
                args[0].become_undefined();
                return args[0];
            });

            add_function("is_undefined", DFIFUN(args) {
                DFI_CHCK_FUN_PARMS_NUM_EQ(args, 1)
                return args[0].is_undefined();
            });

            add_function("is_defined", DFIFUN(args) {
                DFI_CHCK_FUN_PARMS_NUM_EQ(args, 1)
                return !args[0].is_undefined();
            });

            add_function("clone", DFIFUN(args) {
                DFI_CHCK_FUN_PARMS_NUM_EQ(args, 1)
                return args[0].clone();
            });

            add_function("reserve", DFIFUN(args) {
                DFI_CHCK_FUN_PARMS_NUM_EQ(args, 2)
                if(args[0].is_string()) {
            ...
            add_function("slice", DFIFUN(args) {
            ...
            add_function("py_slice", DFIFUN(args) {
            ...
            add_function("subarray", DFIFUN(args) {
                DFI_CHCK_FUN_PARMS_NUM_IN_RANGE(args, 1, 3)
                if(args[0].is_array()) {
                    if(args.size() == 1) {
            ...
            add_function("getset", DFIFUN(args) {
                DFI_CHCK_FUN_PARMS_NUM_EQ(args, 2)
                valbox res{};
                res.assign(args[0]);
            ...
            add_function("get_bit_field", DFIFUN(args) {
            ...
            add_function("get_bit", DFIFUN(args) {
                DFI_CHCK_FUN_PARMS_NUM_EQ(args, 2)
                bit_util::bits<std::uint64_t> bf{args[0].cast_to_u64()};
            ...
            add_function("update_bit", DFIFUN(args) {
                DFI_CHCK_FUN_PARMS_NUM_EQ(args, 3)
                bit_util::bits<std::uint64_t> bf{args[0].cast_to_u64()};
                auto bitpos{args[1].cast_to_u64()};
            ...
            add_function("set_bit", DFIFUN(args) {
                DFI_CHCK_FUN_PARMS_NUM_EQ(args, 2)
                bit_util::bits<std::uint64_t> bf{args[0].cast_to_u64()};
            ...
            add_function("clear_bit", DFIFUN(args) {
                DFI_CHCK_FUN_PARMS_NUM_EQ(args, 2)
                bit_util::bits<std::uint64_t> bf{args[0].cast_to_u64()};
            ...
            add_function("sleep", DFIFUN(args) {
                long double time_to_sleep{args[0].cast_to_long_double()};
                if(time_to_sleep > 0) {
                    std::this_thread::sleep_for(std::chrono::nanoseconds{static_cast<std::uint64_t>(time_to_sleep * 1e9L)});
                }
            ...
            add_function("assign", DFIFUN(args) {
                DFI_CHCK_FUN_PARMS_NUM_EQ(args, 2);
            ...
            add_function("empty", DFIFUN(args) {
                DFI_CHCK_FUN_PARMS_NUM_EQ(args, 1);
            ...
            add_function("sort_r", DFIFUN(args) {
                DFI_CHCK_FUN_PARMS_NUM_EQ(args, 1);
                valbox &arg0{args[0].deref()};
                if(arg0.is_array()) {
                    valbox::array_t &arr{arg0.as_array()};
                    ...
                    if(body_it == worker_bodies_.end()) {
                        throw runtime_error{
                            ...
                            std::string{"\""} + curr_cell_type_name +
                                "\" descriptor not found for instantiation of \"" +
                                curr_cell->inst_name() + "\""
                        };
                    }
        ...
        void set_external_cells_update_interval(long double seconds) override {
            ext_cells_refresh_interval_nanos_ = seconds * 1e9L;
        }
    ...
    private:
        ...
        bool load_library(std::string const &fname) {
            ...
            try {
                ...
                if(dll_ptr->ok()) {
                    auto ld_fn{dll_ptr->symbol<extension_interface *(*)()>("create_dfi_extension")};
                    auto unld_fn{dll_ptr->symbol<void (*)(extension_interface *)>("remove_dfi_extension")};
                    if(ld_fn && unld_fn) {
        ...
        void unload_extensions() {
            ...
            for(auto &&ep: loaded_extensions_) {
                ...
                ep.first->symbol<void (*)(extension_interface *)>("remove_dfi_extension")(ep.second);
                ep.first->close();
            }
    ...
    private:
        ...
        static std::size_t constexpr version_minor_{1};
        static std::size_t constexpr version_patch_{3};
