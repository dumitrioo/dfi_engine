...
class fractal_ext: public dfi::extension_interface {
    class fractal {
    public:
        fractal() {
        }
    ...
    private:
        ...
        mutable dfi::shared_mutex field_mtp_{};
...
public:
    ...
    void register_runtime(dfi::runtime_interface *rt) override {
        ...
        try {
            rt->add_var("fractal_field", dfi::valbox{&frc, "fractal"});
        } catch (...) {
        }
        try {
            rt->add_method("fractal", "set_at", DFIFUN(args) {
        ...
        try {
            rt->add_method("fractal", "get_at", DFIFUN(args) {
        ...
        try {
            rt->add_method("fractal", "dump", DFIFUN(args) {
